...
import '../../../main_screens/presentation/blocs/backend_db_bloc/backend_db_bloc.dart';
                              ...
                              children: [
                               ...
                               isEnglish(context) 
                                ...
                                : IconButton(
                                  ...
                                  icon: Icon(isEnglish(context) ? Icons.forward: Icons.arrow_back,color: theme(context).backgroundColor,),),
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text(
                                ...
                                style: theme(context).textTheme.titleSmall!
                                    .copyWith(fontSize: sizeW(context)*0.06,fontWeight: FontWeight.w900,color: theme(context).focusColor),
                              ),
                            ),
                            Padding(
                              padding: EdgeInsets.symmetric(vertical:isEnglish(context)? sizeH(context) * 0.025:sizeH(context)*0.01),
                              child: Text(
                                  kAuthLoginSubtitle.tr(),
                                style: theme(context)
                                    .textTheme
                                    .titleSmall!
                                    .copyWith(
                            ...
                            Padding(
                              ...
                              child: ElevatedButton(
                                onPressed: () async {
                                  if(key.currentState!.validate()) BlocProvider.of<AuthBloc>(context).add(LogInAuthEvent(context: context,email: email.text,password:password.text.toString(),)); 
                                },
                                ...
                                child: Text(
                                  ...
                                  style: theme(context)
                                      .textTheme
                                      .titleSmall!
                                      .copyWith(fontSize:isEnglish(context) ? sizeW(context)*0.037:sizeW(context)*0.027,color: theme(context).backgroundColor),
                                ),
                              ),
                            ),
                            const Spacer(),
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [   
                                  Text(
                                    kAuthLoginFoother.tr(),
                                    style: theme(context)
                                        .textTheme
                                        .bodySmall!
                                        .copyWith(color: theme(context).focusColor,fontSize: sizeW(context)*0.028),
                                  ),
                                  sizeBoxW(5),
                                  InkWell(
